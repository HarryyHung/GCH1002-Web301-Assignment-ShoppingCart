 ...
 */
class getOrderInfoRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\OrderInfoRepository' shared autowired service.
     *
     * @return \App\Repository\OrderInfoRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'OrderInfoRepository.php';

        return $container->privates['App\\Repository\\OrderInfoRepository'] = new \App\Repository\OrderInfoRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
